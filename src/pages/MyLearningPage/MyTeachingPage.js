        ...
        <div className="course pl-80 pr-10 flex flex-col gap-8 mb-8">
          ...
          <div className="course-list flex flex-col gap-4">
            <div className="course-stat flex gap-3">
              <div className="courses h-72 rounded-lg font-bold bg-white p-3 w-3/5">
                <div className="flex justify-between items-start w-full h-full">
                  <div>Courses</div>
                  <Link
                    to={"/courses/create"}
                    className="bg_mid_courseQuizzy rounded-xl text-white py-2 px-6 "
                  >
                    Create New Course
                  </Link>
                </div>
              </div>
              <div className="statistic h-72 rounded-lg font-bold p-3 bg_light_mid_courseQuizzy w-2/5">
                Statistic
              </div>
            </div>
              ...
              <div className="title-filter-container flex items-center justify-between gap-9 rounded-lg">
                <div className="title-filter flex items-center gap-9">
                  ...
                  <div className="filter-menu flex gap-2 items-center">
                    <p>Sort by: </p>
                    <select
                      className="border-solid border-2 border-color-mid rounded-xl p-1"
                      name="cars"
                      id="cars"
                    >
                ...
                <tbody className="">
                  <tr className="border-2 rounded-xl border-y-[#dbe2ef] border-x-transparent">
                    <td className="">
                      <img
                        src="11.png"
                        className="inline mr-2 border-separate p-1"
                        alt=""
                      ></img>
                      Elle Argent
                    </td>
