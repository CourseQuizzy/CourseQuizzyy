  ...
  return (
    <div className="p-10 fixed bottom-0 top-10 flex flex-col items-center justify-between">
      ...
      <div className="menu flex flex-col gap-1">
        <Link
          to="/dashboard"
          className="flex gap-2 p-2 items-start group rounded-lg hover:bg-[#3f72af]"
        >
          <ReactSVG
            src="icons/dashboard.svg"
            className="h-2 group-hover:stroke-white"
            fill="none"
            viewBox="24 24 24 24"
            alt=""
            beforeInjection={(svg) => {
        ...
        >
          ...
          <ReactSVG
            ...
            className="h-2 group-hover:stroke-white stroke-white"
            fill="none"
            viewBox="24 24 24 24"
            alt=""
            beforeInjection={(svg) => {
