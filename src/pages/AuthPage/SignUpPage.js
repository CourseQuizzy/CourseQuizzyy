        ...
        <div className=" mt-5 mb-10 p-3 w-64 bg-white shadow-[0px_0px_8px_-1px_rgba(0,0,0,0.3)] rounded-md">
                ...
                <div>
                    <form>
                        ...
                        <div>
                            <input className="w-full flex justify-center items-center lato border-2 py-2 px-3 mb-3 rounded-md text-xs" id="username" type="text" placeholder="Username" required />
                        </div>
                        {/* Email */}
                        ...
                        <div>
                            <input className="w-full flex justify-center items-center lato border-2 py-2 px-3 mb-3 rounded-md text-xs" id="email" type="email" placeholder="Email" required />
                        </div>
                        {/* Password */}
                        <div className="font-medium text-xs lato mb-1 ml-0.5">
                        ...
                        <div>
                            <input className="w-full flex justify-center items-center lato border-2 py-2 px-3 mb-3 rounded-md text-xs" id="password" type="password" placeholder="Password" />
                        </div>
                    ...
                    <div className="">
                        <Link
                            ...
                            <img src="/icons/icons-google.svg" alt="login-with-google" className="h-4 w-4 mx-2" />
                            <div>
                                Google
                            </div>
                        </Link>
                    ...
                    <div>
                        <Link to=""
                            className="border-2 flex flex-wrap poppins mb-2 p-1 px-4 text-black font-semibold justify-center rounded-md text-xs">
                            <img src="/icons/icons-facebook.svg" alt="login-with-facebook" className="h-4 w-4 mx-2" />
                            <div>
                                Facebook
                            </div>
                        </Link>
